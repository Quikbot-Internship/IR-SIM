...
def linearProgram2(lines, radius, optVelocity, directionOpt, result):
    #print("optVelocity =", optVelocity, "type:", type(optVelocity))
    #print("absSq(optVelocity) =", absSq(optVelocity))
    if directionOpt:
        # Optimize direction. Note that the optimization velocity is of unit length
        # in this case.
        result = optVelocity * radius
    elif absSq(optVelocity) > radius * radius:
        # Optimize closest point. Note that the optimization velocity is of unit length
